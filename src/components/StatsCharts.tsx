...
const COLORS = ['#9333ea', '#7e22ce', '#6b21a8', '#581c87', '#4c1d95'];
        ...
        <div className="bg-white rounded-3xl shadow-xl border-2 border-purple-100 p-6 sm:p-8">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={last7Days}>
              ...
              />
              <Bar dataKey="minutes" fill="url(#colorPurple)" radius={[8, 8, 0, 0]} />
              <defs>
        ...
        <div className="bg-white rounded-3xl shadow-xl border-2 border-purple-100 p-6 sm:p-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-blue-50 rounded-2xl p-4 border-2 border-blue-100">
              ...
              <p className="text-2xl font-extrabold text-blue-700">{totalMinutes30Days}</p>
            ...
            <div className="bg-purple-50 rounded-2xl p-4 border-2 border-purple-100">
              ...
              <p className="text-2xl font-extrabold text-purple-700">{avgDaily}</p>
              <p className="text-xs text-gray-500 mt-1">minutes</p>
            </div>
          </div>
