...
export default function FAQPage() {
  return (
    ...
    >
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 text-white mb-10 hover:shadow-lg transition-all">
        <p className="text-xl font-semibold flex items-center">
          <span className="text-3xl mr-3">💡</span>
          Can't find what you're looking for? <a href="/support/contact" className="underline ml-2 hover:text-purple-100">Contact us</a>
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-purple-800 mb-6 flex items-center">
            <span className="w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-lg mr-3">
              🎵
            </span>
            General Questions
          </h2>
          ...
          <div className="space-y-4">
            <div className="bg-white border-2 border-purple-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-purple-700 transition-colors">Is PracticePal really free?</p>
            ...
            <div className="bg-white border-2 border-indigo-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-indigo-700 transition-colors">What instruments does PracticePal support?</p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white border-2 border-sky-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-sky-700 transition-colors">Is PracticePal for beginners or advanced musicians?</p>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-bold text-indigo-800 mb-6 flex items-center">
            <span className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-sky-600 rounded-full flex items-center justify-center text-white text-lg mr-3">
              💳
            </span>
            Account & Billing
          </h2>
          ...
          <div className="space-y-4">
            <div className="bg-white border-2 border-purple-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-purple-700 transition-colors">Do I need a credit card to start?</p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white border-2 border-indigo-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-indigo-700 transition-colors">Can I cancel my Pro subscription anytime?</p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white border-2 border-sky-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-sky-700 transition-colors">What's your refund policy?</p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white border-2 border-fuchsia-100 rounded-2xl p-6 hover:shadow-lg transition-all group">
              <p className="font-bold text-gray-900 text-lg mb-3 group-hover:text-fuchsia-700 transition-colors">What happens if I downgrade from Pro to Free?</p>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-bold text-sky-800 mb-6 flex items-center">
            <span className="w-10 h-10 bg-gradient-to-br from-sky-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-lg mr-3">
              ⚡
            </span>
            Features & Usage
          </h2>
          ...
          <div className="space-y-4">
            <div className="bg-white border-2 border-blue-100 rounded-2xl p-6 hover:shadow-lg transition-all">
        ...
        <div>
          <h2 className="text-2xl font-bold text-blue-800 mb-6 flex items-center">
            <span className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center text-white text-lg mr-3">
              🔒
            </span>
            Data & Privacy
          </h2>
      ...
      <div className="mt-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-center text-white">
        ...
        <p className="mb-6 text-blue-100">We're here to help! Reach out and we'll get back to you quickly.</p>
        <a 
          href="/support/contact" 
          className="inline-block bg-white text-blue-700 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-all"
        >
          Contact Support
        </a>
      </div>
